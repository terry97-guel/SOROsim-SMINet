...
%Function No longer asks for input force by dlg.
%input force(uq) is taken as positional param

%Function No longer saves StaticsSolution.mat.

function [q,u]=NodlgStatics(S,qu0,uq) 
